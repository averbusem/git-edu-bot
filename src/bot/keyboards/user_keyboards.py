...
def tests_list_keyboard():
    keyboard = InlineKeyboardBuilder()
    lessons = [
        ("Тест 1. Введение в Git", "test1"),
        ("Тест 2. Установка и настройка Git", "test2"),
        ("Тест 3. Основы работы с Git", "test3"),
        ("Тест 4. Ветвление и слияние", "test4"),
        ("Тест 5. Работа с удалёнными репозиториями", "test5"),
        ("Тест 6. Отмена изменений и исправление ошибок", "test6"),
        ("Тест 7. Продвинутые возможности Git", "test7"),
    ]
